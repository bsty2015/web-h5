...
(function (__global__) {
    ...
    var date_formatters = __global__._formats = {
        ...
        // ISO 8601 date
        c: function (d, l) {
            return __global__.format(d, 'Y-m-d\\TH:i:s.', l) + __global__.pad(d.getUTCMilliseconds(), 3) + 'Z';
        },
        // Day of the month, 2 digits with leading zeros
        d: function (d) {
            return __global__.pad(d.getUTCDate());
        },
        // A textual representation of a day, three letters
        D: function (d, l) {
            return __global__._(_d[d.getUTCDay()].substr(0, 3), l);
        },
        ...
        F: function (d, l) {
            return __global__._(_m[d.getUTCMonth()], l);
        },
        ...
        h: function (d) {
            return __global__.pad(d.getUTCHours() % 12 || 12);
        },
        // 24-hour format of an hour with leading zeros
        H: function (d) {
            return __global__.pad(d.getUTCHours());
        },
        // Minutes with leading zeros
        i: function (d) {
            return __global__.pad(d.getUTCMinutes());
        },
        ...
        l: function (d, l) {
            return __global__._(_d[d.getUTCDay()], l);
        },
        // Whether it's a leap year (0 = yes, 1 = no)
        L: function (d) {
            return __global__.isLeapYear(d) * 1;
        },
        // Numeric representation of a month, with leading zeros
        m: function (d) {
            return __global__.pad(d.getUTCMonth() + 1);
        },
        // A short textual representation of a month, three letters
        M: function (d, l) {
            return __global__._(_m[d.getUTCMonth()].substr(0, 3), l);
        },
        ...
        o: function (d) {
            return __global__.pad(__global__.isocalendar(d)[0], 4);
        },
        ...
        r: function (d, l) {
            return __global__.format(d, 'D, d M Y H:i:s O', l);
        },
        // Seconds, with leading zeros
        s: function (d) {
            return __global__.pad(d.getUTCSeconds());
        },
        ...
        t: function (d) {
            return __global__.daysInMonth(d);
        },
        ...
        // Microseconds
        u: function (d) {
            return __global__.pad(d.getUTCMilliseconds(), 6);
        },
        ...
        W: function (d) {
            return __global__.pad(__global__.isocalendar(d)[1]);
        },
